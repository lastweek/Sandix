/*
 *	Atomic Compare and Exchange Related
 *
...
/* 
 * An exchange-type operation, which takes a value and a pointer,
...
/**
 * cmpxchg() is locked when multiple cpus are online
 * cmpxchg_sync() is always locked
 * cmpxchg_local() is never locked
 */
